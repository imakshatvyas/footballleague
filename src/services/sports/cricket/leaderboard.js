...
import { getRecentResults, getCricketWinner } from "./fixtures";
...
const buildFinishedMatchMap = (matches) =>
  matches.reduce((matchMap, match) => {
    ...
    matchMap.set(String(match.fixture.id), {
      fixtureId: match.fixture.id,
      date: match.fixture.date || null,
      actualWinner: getCricketWinner(match),
    });
      ...
      return {
        ...
        accuracy:
          stats.totalPredictions > 0
            ...
            : 0,
        exactScoreAccuracy: 0, // No exact score predictions for Cricket
